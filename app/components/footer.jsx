...
const footer = () => {
  return (
<div  className='w-full  py-16 px-10 grid lg:grid-cols-3 gap-8 text-gray-300 bg-zinc-900 '>
      <div>
        <h1 className='w-full text-3xl font-bold'>MÁS VENDING</h1>
      ...
      <div className="grid grid-cols-3 gap-4 ">
        ...
        <div>
          <h6 className='font-medium text-gray-400'>MÁS SOBRE NOSOTROS</h6>
          <ul>
            <li className='py-2 text-sm'>Maquina de Cafe</li>
            <li className='py-2 text-sm'>Maquina de Bebestible</li>
            <li className='py-2 text-sm'>Maquina de Bebestible & Snack</li>
